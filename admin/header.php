        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.php" class="navbar-brand mx-4 mb-3">
                    <h6 class="text-primary"><i class="fa fa-user-edit me-2"></i>UniqueDancedAcedamy</h6>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="form.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Admission Forms</a>
                    ...
                    <a href="logout.php" class="nav-item nav-link"><i class="fas fa-sign-out-alt me-2"></i>Log Out</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
